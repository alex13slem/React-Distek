...
export const Header = () => {
	...
	const headerHeight = headerRef.current?.scrollHeight as number

	const [prevScrollPosition, setPrevScrollPosition] = useState(1)
	const [currentScrollPosition, setCurrentScrollPosition] = useState(0);
	const [headerTopValue, setHeaderTopValue] = useState(0)

	console.warn(`start code headerTopValue = ${headerTopValue}`)
	console.log(`start code prevScrollPos = ${prevScrollPosition}`)
	console.log(`start code currentScrollPos = ${currentScrollPosition}`)

	const handleScroll = () => {
		console.group()
		console.warn(`start func headerTopValue = ${headerTopValue}`)
		console.log(`start func prevScrollPos = ${prevScrollPosition}`)
		console.log(`start func currentScrollPos = ${currentScrollPosition}`)
		...
		let scrollStep = headerTopValue - (currentScrollPosition - prevScrollPosition)
					...
					<nav className="header__navbar">
						...
						>
							<svg width="123" height="36" viewBox="0 0 123 36" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M85.5921 8.85547H82.5312V26.8583H85.5921V15.7293H88.6529V12.6915H85.5921V8.85547Z" fill="#197ACF" />
								<path d="M63.01 12.6914H59.9492V26.8583H63.01V12.6914Z" fill="#197ACF" />
								<path d="M63.01 8.85547H59.9492V11.8933H63.01V8.85547Z" fill="#197ACF" />
								<path d="M40.5938 8.91895V26.8587H53.8091L56.8699 23.8438V11.9338L53.8091 8.91895H40.5938ZM53.8091 23.8036H43.6719V9.4128L46.2352 11.9338H53.8265L53.8091 23.8036Z" fill="#197ACF" />
								<path d="M79.4999 15.7292L78.4468 12.6914H67.3839L65.9258 17.3945L76.5953 23.8434H66.4407L66.8805 26.8583H78.6146L80.009 22.2987L69.1428 15.7292H79.4999Z" fill="#197ACF" />
								<path d="M118.673 26.8583H123.001L115.085 19.0887L120.704 12.6743H116.648L111.319 18.7614V8.85547H108.258V26.8583H111.319V23.3956L113.078 21.3857L118.673 26.8583Z" fill="#197ACF" />
								<path d="M105.859 17.8363L104.066 12.668H92.3545L91.0469 15.746V22.2982L92.6728 26.8578H103.73L104.661 23.8142H94.0498V23.7453L105.859 17.8363ZM94.0498 17.4228V15.9297H102.729L94.0498 20.1333V17.4228Z" fill="#197ACF" />
								...
								<path d="M23.5859 31.4866V4.52539L31.4145 8.99883V27.0017L23.5859 31.4866Z" fill="#197ACF" />
								<path d="M8.23438 31.7165C8.66254 31.573 23.5848 22.7754 23.5848 22.7754L31.4133 27.0019L15.71 36.0005L8.23438 31.7165Z" fill="url(#paint0_linear_1134_1074)" />
								<path d="M8.23438 13.9544L15.71 9.2627V36L8.23438 31.716V13.9544Z" fill="url(#paint1_linear_1134_1074)" />
