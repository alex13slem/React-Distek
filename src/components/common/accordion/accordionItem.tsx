		...
		<div className={`accordion__item ${isOpen ? 'active' : ''} ${classItem}`} >
			...
			>
				...
				<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
					...
					<path className="minus" d="M11 7.30943V8.53774H5V7.30943H11ZM8.70341" />
					<path fill-rule="evenodd" clip-rule="evenodd" d="M2 0C0.895432 0 0 0.895416 0 2V14C0 15.1046 0.895432 16 2 16H14C15.1046 16 16 15.1046 16 14V2C16 0.895416 15.1046 0 14 0H2ZM2 1C1.44772 1 1 1.44772 1 2V14C1 14.5523 1.44772 15 2 15H14C14.5523 15 15 14.5523 15 14V2C15 1.44772 14.5523 1 14 1H2Z" />
				</svg>
